...
def seed_demo_data(session: Session) -> dict[str, int]:
    ...
    job_sources = [
        JobSourceConfig(
            ...
            last_sync_started_at=dt("2026-04-12T08:45:00Z"),
            last_sync_completed_at=dt("2026-04-12T08:45:00Z"),
            last_successful_sync_at=dt("2026-04-12T08:45:00Z"),
        ...
        JobSourceConfig(
            ...
            external_identifier="relay",
            display_name="Lever / Relay",
    ...
    jobs = [
        Job(
            ...
            raw_payload={"boardToken": "northstar", "id": 12345, "title": "AI Program Manager"},
